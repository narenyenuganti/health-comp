...
| --- | --- | --- |
| Application source | `cb211896eb422909bff0561f3fb25b5d4942b06b`, the selected application baseline and build-source commit; later evidence-only documentation commits do not change that selection | PASS |
...
| Backend CI | Selected-application post-merge [run 32442953606](https://github.com/narenyenuganti/health-comp/actions/runs/32442953606) completed successfully on application baseline `cb21189`. Exact PR #48 head [run 32440813806](https://github.com/narenyenuganti/health-comp/actions/runs/32440813806) passed before merge | PASS |
| iOS CI | Selected-application post-merge [run 32442953541](https://github.com/narenyenuganti/health-comp/actions/runs/32442953541) completed successfully on application baseline `cb21189`: deterministic generation, both Core configurations, the complete app-test suite, unsigned Debug/Staging/Release device builds, and the clean-tree check passed. Exact PR #48 head [run 32440813807](https://github.com/narenyenuganti/health-comp/actions/runs/32440813807) passed the same matrix before merge | PASS |
